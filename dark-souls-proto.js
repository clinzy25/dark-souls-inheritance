...
function Character(name, sex, gift, physique, stats, inventory) { //Supertype and its behaviors to be passed
    this.name = name;
    this.sex = sex;
    this.gift = gift;
...
Character.prototype.move = () => log('move') //Add methods to the prototype
Character.prototype.lightAttack = () => log('light attack')
Character.prototype.strongAttack = () => log('strong attack')
Character.prototype.select = () => log('select')
